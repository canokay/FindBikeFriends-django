# Generated by Django 2.0.9 on 2019-05-13 12:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bike_group', models.ManyToManyField(related_name='bikegroup', to='FindBikeFriends_app.BikeGroup', verbose_name='Bisiklet Grubu')),
            ],
            options={
                'verbose_name': 'Chat',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=100, null=True, verbose_name='İsim')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.ImageField(upload_to='images/event/', verbose_name='Reklam Thumbnail')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('chat_message', models.CharField(max_length=500, verbose_name='Message')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Date')),
                ('chat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='source_chat', to='FindBikeFriends_app.Chat', verbose_name='Chat')),
            ],
            options={
