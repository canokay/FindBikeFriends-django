...
from FindBikeFriends_app.api import EventListView,EventDetailView, AdvertisementListView, AdvertisementDetailView, EventCreateView
...
urlpatterns = \
    [
        ...
        url(r'^event-ekle/$', EventCreateView.as_view()),
